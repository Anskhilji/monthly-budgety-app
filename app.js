...
return {
    addItem: function(type, des, val){
        ...
        // creat new item base on 'exp' or 'inc' type
        if(type === 'exp'){
    ...
    calculateBudget: function(){
        ...
        if(data.totals.inc > 0){
            ...
            // Expense = 100 and income 300, spent 33.333, = 100/33.333 = 0.33333 * 100
        }else{
            data.percentage = -1;
        }
    ...
    return {
        getInput: function() {
         ...
         addListItem: function(obj, type){
            ...
            // Replace the placesholders text with some actual text
...
var controller = (function (budgetCtrl, UIctrl) {
    ...
    // 2. return the calculate budget
        var budget = budgetCtrl.getBudget();
    // 6. displat the budget to the UI
    UIctrl.displayBudget(budget);
    };

    var updatePercenteges = function(){
        //1. Calcutate percentage
